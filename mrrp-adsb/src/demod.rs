...
impl Demodulator {
    ...
    pub fn next(&mut self, cursor: &mut Cursor<f32>) -> Option<RawFrame> {
    ...
    fn read_frame(&mut self, cursor: &mut Cursor<f32>) -> Result<RawFrame, DemodFail> {
        self.num_errors = 0;
