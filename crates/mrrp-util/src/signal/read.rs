...
mod tests {
    ...
    #[tokio::test]
    async fn repeat_outputs_repeated_samples() {
    ...
    #[tokio::test]
    async fn it_maps_in_place_with_same_sample_size() {
        let input = repeat(12u8);
    ...
    #[tokio::test]
    async fn it_maps_in_place_with_smaller_input_samples() {
        let input = repeat(12u8);
        let mut output = [0; 100];
        input
    ...
    #[tokio::test]
    async fn it_maps_in_place_with_larger_input_samples() {
